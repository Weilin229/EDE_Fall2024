---
title: 'WeilinWang_A06_CraftingReports.Rmd'
author: "Weilin wang" 
date: "Fall 2024"
output: pdf_document
---
...
```{r plot_ozone_2018, echo=FALSE, fig.height=4, fig.width=6, fig.align='left', fig.cap="Ozone levels by month in 2018", warning=FALSE, message=FALSE}
# Filter the data for 2018
epa_data_2018 <- epa_data %>% filter(year(Date) == 2018)

# Create a boxplot for Ozone levels by month (2018)
ggplot(epa_data_2018, aes(x = factor(month(Date)), y = AQI_Ozone)) +
  geom_boxplot() +
  labs(x = "Month", y = "Ozone Levels (ppm)", title = "Ozone Levels by Month (2018)") +
  theme_minimal()
```

```{r plot_ozone_2019, echo=FALSE, fig.height=4, fig.width=6, fig.align='left', fig.cap="Ozone levels by month in 2019", warning=FALSE, message=FALSE}
# Filter the data for 2019
epa_data_2019 <- epa_data %>% filter(year(Date) == 2019)

# Create a boxplot for Ozone levels by month (2019)
ggplot(epa_data_2019, aes(x = factor(month(Date)), y = AQI_Ozone)) +
  geom_boxplot() +
  labs(x = "Month", y = "Ozone Levels (ppm)", title = "Ozone Levels by Month (2019)") +
  theme_minimal()
```
